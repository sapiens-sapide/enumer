...
To transform it from CamelCase to UPPERCASE, lowerCamelCase, snake_case or kebab-case, you can use the `transform` flag.
...
```
**Note**: The transformation only works form CamelCase to UPPERCASE, lowerCamelCase, snake_case or kebab-case, not the other way around.
...
Possible transform values are `upper`, `lowercamel`, `snake` and `kebab` for transformation to UPPERCASE lowerCamelCase, snake_case and kebab-case case accordingly.
